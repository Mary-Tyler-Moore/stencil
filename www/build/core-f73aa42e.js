...
const patchBrowser = async () => {
    ...
    if (importMeta !== '') {
        ...
        if (!window.customElements) {
            // @ts-ignore
            await __sc_import_app('./dom-59290340-59290340.js');
        }
    ...
    if ((BUILD.lazyLoad || BUILD.style) && (hostRef.$flags$ & 32 /* hasInitializedComponent */) === 0) {
        ...
        if (BUILD.style && !styles.has(scopeId) && Cstr.style) {
            ...
            if (!BUILD.hydrateServerSide && BUILD.shadowDom && cmpMeta.$flags$ & 8 /* needsShadowDomShim */) {
                style = await __sc_import_app('./shadow-css-9e778f69-c68d0961.js').then(m => m.scopeCss(style, scopeId, false));
            }
...
export { Build as B, Host as H, patchEsm as a, bootstrapLazy as b, config as c, getIonMode as d, createEvent as e, getElement as f, globals as g, h, readTask as i, isPlatform as j, getConnect as k, getAssetPath as l, getMode as m, patchBrowser as p, registerInstance as r, writeTask as w };
